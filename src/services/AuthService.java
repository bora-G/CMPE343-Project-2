...
public class AuthService {
    ...
    public User login(String username, String passwordPlainText) {
        ...
        if (!persistedUser.getPassword_hash().equals(hashedPassword)) {
            // FALLBACK: Check if password matches plain text (for initial data)
            if (!persistedUser.getPassword_hash().equals(passwordPlainText)) {
                return null;
            }
        }
